                        ...
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="mail.php" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" name="name" value="" placeholder="Last Name" required>
                                    </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        <textarea name="message" class="form-control w-100" id="message" cols="30" rows="10" placeholder="Leave a message"></textarea>
                                    </div>
                                    <button class="btn amado-btn mb-15 " type="submit">Send</button>
                                </div>
                            </form>
                        </div>
                    </div>
